...
class PhotoGallery{
    constructor(){
        ...
        this.picturesContainer = document.querySelector('.picturesContainer')
    }
    randomElement(array){
    ...
    generatePicturesDB(number){
        ...
        for (let i = 0; i < number; i++) {
            ...
            for (let j = 0; j < commentCount; j++) {
                comments.push(this.randomElement(this.allComment))
            ...
            pictures.push({
                ...
                comments: comments,
                commentsNumber: commentCount.length
            })
    ...
    showPictures(){
        ...
        this.picturesDB.forEach((photo)=>{
            ...
            this.picturesContainer.append(photoBlock)
        })
