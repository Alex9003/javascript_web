...
let selectedStyle = '';
while(notAnswer){
    userChise = prompt("Ввидебіть тему: \nтема 1. \nтемна 2. світла ");
    switch(userChise){
        case '1':{
            alert("Dark");
            notAnswer = false;
...
let heaber = "<header><h1>Пірати Карибського моря</h1><hr>"
...
heaber += moviesList + '</header>';
container = container + heaber + descriptionMovies +'</div>';

// показуємо весь текст (документ)
